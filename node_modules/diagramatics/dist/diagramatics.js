...
class DragAndDropHandler {
    ...
    replace_draggable_svg(name, diagram) {
        ...
        if (draggable == undefined)
            return;
        (_a = draggable.svgelement) === null || _a === void 0 ? void 0 : _a.remove();
...
class ButtonHandler {
    ...
    remove(name) {
        ...
        b === null || b === void 0 ? void 0 : b.remove();
    ...
    try_add_click(name, diagram, diagram_pressed, diagram_hover, callback) {
        if (this.svg_g_element[name] != undefined) {
            ...
            old_svg_hover === null || old_svg_hover === void 0 ? void 0 : old_svg_hover.remove();
        }
        this.add_click(name, diagram, diagram_pressed, diagram_hover, callback);
    }
    // TODO: handle touch input moving out of the button
    add_click(name, diagram, diagram_pressed, diagram_hover, callback) {
